...
INSERT INTO `HYUPUP`.`EPICS` (`ID`, `PROJECT_ID`, `NAME`, `START_AT`, `END_AT`) VALUES ('1', '1', '첫에픽', NOW(), NOW());

INSERT INTO `HYUPUP`.`EPICS` (`ID`, `NAME`, `PROJECT_ID`,  `START_AT`, `END_AT`) VALUES ('2', '두번째에픽', '2', NOW(), NOW()); 
